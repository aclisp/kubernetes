...
$ sigctl describe TYPE NAME_PREFIX
...
$ sigctl describe nodes kubernetes-minion-emt8.c.myproject.internal

# Describe a pod
$ sigctl describe pods/nginx

# Describe a pod identified by type and name in "pod.json"
$ sigctl describe -f pod.json

# Describe all pods
$ sigctl describe pods

# Describe pods by label name=myLabel
$ sigctl describe po -l name=myLabel

# Describe all pods managed by the 'frontend' replication controller (rc-created pods
# get the name of the rc as a prefix in the pod the name).
$ sigctl describe pods frontend`
)
